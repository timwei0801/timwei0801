...
const timelineItems = [
  ...
  // 2025/07
  {
    ...
    subtitle: '全端開發 & AI 工程師實習生',
    subtitleEn: 'Full-Stack Developer & AI Engineer Intern',
    period: '2025/07 - Present',
    location: 'Taipei',
    description: '於全球四大會計師事務所之一的 EY 台灣擔任技術部門全端開發與 AI 工程師實習生，負責企業級專案管理系統的前後端開發，協助建立公司內部 AI RAG 知識管理系統，並將於 2026 年 2-6 月擔任台大會計學系課程助教。',
    descriptionEn: 'Full-stack developer and AI engineer intern at EY Taiwan (Big Four), responsible for enterprise project management system development, building internal AI RAG knowledge management system, and will serve as Teaching Assistant at NTU Accounting Department (Feb - Jun 2026).',
    achievements: [
      '獨立負責 Vue.js 前端模組開發，實現組件化架構與 RESTful API 整合',
      '協助建立公司內部 AI RAG 知識管理系統，提升資訊檢索效率',
      '開發 Python 自動化爬蟲系統，每週節省 10+ 小時人工作業',
      '即將擔任台大會計學系課程助教（2026/02 - 2026/06）',
    ],
    achievementsEn: [
      'Led Vue.js frontend module development with component-based architecture and RESTful API integration',
      'Building internal AI RAG knowledge management system to improve information retrieval',
      'Developed Python automation system, saving 10+ hours of manual work weekly',
      'Upcoming Teaching Assistant at NTU Accounting Department (Feb - Jun 2026)',
    ],
    tags: ['Vue.js', 'Python', 'Spring Boot', 'AI/RAG', 'LLM'],
    logo: eyLogo,
