export default {
    ...
    hero: {
        ...
        headline2: '從研究做到',
        headlineEm: '產品。',
        subline: "AI/ML Engineer {'@'} EY · 淡江資料科學碩士 · 帶 RAG {'@'} NTU",
    ...
    about: {
        ...
        titleSep: '到',
        titleEm2: '產品。',
        intro1: '我是<strong>魏祺紘 (Tim)</strong>,目前在<strong>安永聯合會計師事務所 (EY Taiwan)</strong> 擔任 AI/ML 算法工程師,並取得<strong>淡江大學統計與資料科學學系</strong>數據科學碩士學位。',
