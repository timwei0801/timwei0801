export default {
    ...
    hero: {
        ...
        headline2: '從研究做到',
        headlineEm: '產品。',
        subline: "AI/ML Consultant {'@'} EY · 淡江資料科學碩士 · 帶 RAG {'@'} NTU",
        ...
        items: [
            {
                ...
                position: 'Technology Consulting 顧問 · AI/ML',
                company: 'Ernst & Young (EY Taiwan)',
                location: '台北 · 信義區',
                description: '於四大會計師事務所之一的安永台灣,隸屬 Technology Consulting 部門擔任顧問,主責企業級 AI/ML 解決方案的設計、開發與落地,實際專業與產出以 AI/ML 算法工程為主。',
                bullets: [
