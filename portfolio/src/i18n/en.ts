export default {
    ...
    about: {
        ...
        titleSep: ' to ',
        titleEm2: 'production.',
        intro1: "I'm <strong>Tim Wei</strong>, an intern in the Technology Consulting practice at <strong>Ernst & Young Taiwan (EY)</strong> — with AI/ML as my specialty — holding an M.S. in Data Science from <strong>Tamkang University</strong>.",
        intro2: "At EY, I built the architecture and implementation of an internal RAG knowledge system and contributed to credit-scoring model development for a banking client, and I'm now building a per-patient health-education RAG system with a healthcare institution and a real-time ML recommendation engine for a major retail chain — turning research into shipped products.",
        ...
        items: [
            {
                ...
                bullets: [
                    ...
                    '<strong>Banking Credit Scoring</strong>: Contributed to the development of a credit scoring model for a banking client. Completed SAS Viya certification and supported the client through SAS Viya platform onboarding and model pipeline setup.',
                    '<strong>AI Model Governance</strong>: Responsible for fairness, explainability and AI capability evaluation for enterprise clients — delivering SHAP feature-importance analysis and multi-dimension fairness audit reports to surface model risk.',
