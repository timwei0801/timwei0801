export default {
    ...
    hero: {
        ...
        subline: "AI/ML Engineer {'@'} EY · M.S. Data Science, Tamkang · Mentored RAG {'@'} NTU",
    ...
    about: {
        ...
        titleSep: ' to ',
        titleEm2: 'production.',
        intro1: "I'm <strong>Tim Wei</strong>, AI/ML Algorithm Engineer at <strong>Ernst & Young Taiwan (EY)</strong>, with an M.S. in Data Science from <strong>Tamkang University</strong>.",
